...
namespace IntermediateCSharp.Assignment10 {
    ...
    public partial class MoviesDataSet : global::System.Data.DataSet {
        ...
        public partial class MovieDataTable : global::System.Data.TypedTableBase<MovieRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MovieRow AddMovieRow(string Title, int Year, string Genre, string Rating) {
...
namespace IntermediateCSharp.Assignment10.MoviesDataSetTableAdapters {
    ...
    public partial class MovieTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Movie` WHERE ((`Title` = ?) AND ((? = 1 AND `Year` IS NULL) OR (`Yea" +
                "r` = ?)) AND ((? = 1 AND `Genre` IS NULL) OR (`Genre` = ?)) AND ((? = 1 AND `Rat" +
                "ing` IS NULL) OR (`Rating` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Movie` (`Title`, `Year`, `Genre`, `Rating`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Movie` SET `Title` = ?, `Year` = ?, `Genre` = ?, `Rating` = ? WHERE ((`Ti" +
                "tle` = ?) AND ((? = 1 AND `Year` IS NULL) OR (`Year` = ?)) AND ((? = 1 AND `Genr" +
                "e` IS NULL) OR (`Genre` = ?)) AND ((? = 1 AND `Rating` IS NULL) OR (`Rating` = ?" +
                ")))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::IntermediateCSharp.Assignment10.Properties.Settings.Default.MoviesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Title, [Year], Genre, Rating FROM Movie";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Title, [Year], Genre, Rating FROM Movie WHERE (Title = ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Title", global::System.Data.OleDb.OleDbType.WChar, 50, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Title", global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual int FillByTitle(MoviesDataSet.MovieDataTable dataTable, string Title) {
        ...
        public virtual MoviesDataSet.MovieDataTable GetDataByTitle(string Title) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Title == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int Delete(string Original_Title, global::System.Nullable<int> Original_Year, string Original_Genre, string Original_Rating) {
        ...
        public virtual int Insert(string Title, global::System.Nullable<int> Year, string Genre, string Rating) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, global::System.Nullable<int> Year, string Genre, string Rating, string Original_Title, global::System.Nullable<int> Original_Year, string Original_Genre, string Original_Rating) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> Year, string Genre, string Rating, string Original_Title, global::System.Nullable<int> Original_Year, string Original_Genre, string Original_Rating) {
            return this.Update(Original_Title, Year, Genre, Rating, Original_Title, Original_Year, Original_Genre, Original_Rating);
        }
    }
